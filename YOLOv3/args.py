...
val_file = './data/my_data/test.txt'  # The path of the validation txt file.
restore_path = './data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = './checkpoint2/'  # The directory of the weights to save.
log_dir = './data/logs2/'  # The directory to store the tensorboard log files.
progress_log_path = './data/progress2.log'  # The path to record the training progress.
anchor_path = './data/yolo_anchors.txt'  # The path of the anchor txt file.
class_name_path = './data/coco_dataset_VGR.names'  # The path of the class names.
